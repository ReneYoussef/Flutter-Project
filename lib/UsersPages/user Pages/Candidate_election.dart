...
class Candidate_election extends StatefulWidget {
  const Candidate_election({Key? key});

  @override
  State<Candidate_election> createState() => _Candidate_electionState();
}

class _Candidate_electionState extends State<Candidate_election> {
  String? userId;
                          ...
                          child: StreamBuilder(
                            ...
                            builder: (context,
                              ...
                              if (!snapshot.hasData ||
                                ...
                                return Text(
                                    'No candidates available for this city');
                              }
                                    ...
                                    children: [
                                      ElevatedButton(
                                        ...
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: Color(0xFA1100FF)
                                              .withOpacity(0.75),
                                        ),
                                      ),
                                      SizedBox(
                                  ...
                                  Expanded(
                                    child: ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        var userData = candidateDocs[index]
...
//////////////////////////////Function////////////////////////////////
  ...
  void voteForCandidate(String userId, String candidateId, String City) async {
    String? userId = await getUserId();
    print('////////////$userId ///////////');
    if (userId != null) {
      String candidateId = 'example_candidate_id';
      voteForCandidate(userId, candidateId, City);
    } else {
